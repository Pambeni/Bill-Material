                                            ...
                                            <div class="tab-pane" id="about">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-10">
                                                        ...
                                                        <a data-toggle="modal" data-target="#squarespaceModal2">
                                                            <button class="btn btn-lg btn-rose" style=" margin: -60px -50px; 
                                                              position:relative;    top:50%;   left:50%;" type="button"> <i class="menu-icon fa fa-search"></i> Search Client</button>
                                                        </a>
                                                        <br/>
                                                        <a  data-toggle="modal" data-target="#create" class="btn btn-linkedin btn-round">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="material-datatables">
                                            ...
                                            ?>
                                                        <tr>
                                                            <td>
                                                                <a href="registration.php?<?php echo " id=$id&x=1 "?>">
                                                                    <?php echo $name?>
                                                                </a>
                                                            </td>
                                                            <td>
