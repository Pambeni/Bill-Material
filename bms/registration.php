                                ...
                                <form action="#" method="post">
                                    ...
                                    <div class="wizard-navigation">
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <li>
                                                    <a href="#number" data-toggle="tab">Billboard Number</a>
                                                </li>
                                        </ul>
                                    </div>
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="number">
                                            <div class="form-row">
                                                <div class="form-group col-md-10">
                                                   <a href="#" class="dropdown-toggle" a data-toggle="modal" data-target="#mediumModal" aria-haspopup="true" aria-expanded="false">      <button class="btn btn-lg btn-danger" style=" margin: -60px -50px; 
                                                      position:relative;    top:50%;   left:50%;" type="button"> <i class="menu-icon fa fa-search"></i> Search Billboard</button>
                                                   <a/>
                                                      <br/>
                                                </div>
                                             </div>
