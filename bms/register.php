                                    ...
                                    <div class="card-content">
                                        <div class="info info-horizontal">
                                            ...
                                            <div class="description">
                                                ...
                                                <p class="description">
                                                  To have access to the Billboard Management System, Acquire a temporary Access Code from the Systme Admin
                                                </p>
                                            </div>
                                        </div>
                                        <div class="info info-horizontal">
                                            ...
                                            <div class="description">
                                                <h4 class="info-title">Pre-requistes</h4>
                                                <p class="description">
                                                    Please ensure that you read the user manual before using the system and ensure that there is internet connection.
                                                </p>
                                            </div>
                                        </div>
                                        <div class="info info-horizontal">
                                            ...
                                            <div class="description">
                                                <h4 class="info-title">Must Know</h4>
                                                <p class="description">
                                                    The system is role based hence all the actions perfomed on the system are based on the roles assigned to the user upon registration 
                                                </p>
                                            </div>
                                        </div>
                                    </div>
            ...
            <footer class="footer">
                    <div class="container">
                        ...
                        <p class="copyright pull-right">
                            ...
                            <a href="http://www.intelliafrica.solution/">Intelli Africa Solutions</a>, Software Solutions For Africa
                        </p>
                    </div>
                </footer>
        </div>
